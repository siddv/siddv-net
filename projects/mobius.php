...
<h1 id="intro">Mobius<br/> <span>An expandable, wireless, user-friendly framework for Arduino.</span></h1>

	<article class="artile full"> 
		<div class="outer-yt-wrap">
			<div class="yt-wrap">
				<iframe src="//www.youtube.com/embed/sGnerJxazpQ" frameborder="0" allowfullscreen></iframe>
			</div>
		</div>
	</article>
			...
			<p>
				...
				<ul>
					<li>The Webapp
						...
						<img alt="Mobius screenshot" src="/resources/images/portfolio/mobius/webapp-screenshot.png" id="webapp-screenshot"/>
					</li>
					<li>The Hub
						<ul>
							<li>
						...
						<img alt="Mobius hub" src="/resources/images/portfolio/mobius/mobius-hub.jpg" id="mobius-hub"/>
					</li>
					<li>The Devices
						<ul>
							<li>
						...
						<img alt="Mobius devices" src="/resources/images/portfolio/mobius/mobius-devices.jpg" id="mobius-devices"/>
					</li>
				</ul>
	...
	<article class="artile full smaller"> 
		<article class="inner_artile">
			<img alt="Mobius diagram" src="/resources/images/portfolio/mobius/mobius_diagram.png" id="mobius-diagram"/>
		</article>
	</article>
