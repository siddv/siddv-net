  ...
  projects: [
    {
      ...
      description: `Led a greenfield build for a major QSR, overseeing 12 engineers across four organizations to deliver a user-centric self-service kiosk in physical retail. We built it from scratch, ensuring seamless integration with scanners, printers, and payment terminals.`,
      cta: {
        disabled: true
      }
    },
    ...
    {
      title: 'N9 Design',
      img: require('~/assets/images/portfolio/n9@2x.jpg'),
    ...
    {
      title: 'Quartz',
      img: require('~/assets/images/portfolio/quartz@2x.jpg'),
    ...
    },
    {
      ...
      img: require('~/assets/images/portfolio/lapscreen@2x.jpg'),
      description: `This was a project I undertook when my previous laptop died. Aiming to reuse as many of the components as possible, I modified the laptop's screen to function as an external monitor. This project was quite popular, generating around 1.2 million hits across a number of media websites, including Hacker News and Reddit.`,
      cta: {
