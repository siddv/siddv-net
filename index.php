	...
	<section class="artile full" id="portfolio"> 
		<article class="inner_artile">
			...
			<article class="project">
				<img src="/resources/images/portfolio/mobius.png" />
				<article>
					<h3>Mobius</h3>
			...
			<article class="project">
				<img src="/resources/images/portfolio/british-airways.png" />
				<article>
			...
			<article class="project">
				<img src="/resources/images/portfolio/n9.jpg" />
				<article>
					<h3>N9 Design</h3>
			...
			<article class="project">
				<img src="/resources/images/portfolio/quartz.jpg" />
				<article>
					<h3>Quartz</h3>
			...
			<article class="project">
				<img src="/resources/images/portfolio/lapscreen.jpg" />
				<article>
			...
			<article class="project">
				<img src="/resources/images/portfolio/koth.jpg" />
				<article>
					<h3>KOTH</h3>
			...
			<article class="project">
				<img src="/resources/images/portfolio/termisoc.jpg" />
				<article>
					<h3>TermiSoc</h3>
					...
					<a href="/projects/termisoc" class="view-more">view project</a>
				</article>
			</article>

			<article class="project">
				<img src="/resources/images/portfolio/towif.jpg" />
				<article>
					...
					<a href="/projects/the-only-way-is-freshers" class="view-more">view project</a>
				</article>
			</article>
